...
export default class TabPage2 extends Component {
    ...
    render() {
        return (
            <>
                <div className="tab-pane fade" role="tabpanel" id="tab-patient-history-content" aria-labelledby="tab-patient-history">
                            ...
                            <div className="col-3 vh-100 overflow-auto">
                                ...
                                <div className="card border border-phcn mb-3">
                                    <div className="card-body">
                                        <p className="card-text"><small className="text-muted">Dr. Who</small></p>
                                ...
                                <div className="card border border-phcn mb-3">
                                    <div className="card-body">
                                        <p className="card-text"><small className="text-muted">Dr. Dre</small></p>
                                        <p className="card-text">This is another card with title and supporting text below. This card has some additional content to make it slightly taller overall.</p>
                                        <p className="card-text"><small className="text-muted">Last updated 3/21/22 @9:00am</small></p>
                                    </div>
                                </div>
